...
def _rewrite_with_inference_api(para: str, client, register: str = 'casual') -> str:
    ...
    if register == 'professional':
        system_content = (
            ...
            "1. KEEP SPECIFIC DETAILS AND DESCRIPTIONS WITHOUT ADDING NEW DETAILS. Do not round off, simplify, summarize, or omit the specific details of the original text. Keep concrete descriptions intact (e.g. if the original mentions 'an older man about the football team they both supported', do not simplify it to 'a man about football'; keep the full detail). Humans hoard specifics, while AI rounds them off. At the same time, do not invent, hallucinate, or add details, characters, or facts that are not in the original text (e.g. do not invent characters like 'a woman who bought flowers' if they are not in the original text). Keep the factual meaning identical.\n"
            "2. VARY SENTENCE LENGTH AND RHYTHM (BURSTINESS). Do not make all sentences short or uniform. Mix short, punchy sentences (5-10 words) with medium sentences (11-17 words) and a few longer, flowing sentences (18-25 words). The average sentence length should be around 13-16 words. This is critical to avoid monotonous rhythm.\n"
            "3. USE VARIED SYNTAX. Avoid repetitive subject-verb-object structures. Use relative clauses, conditional statements, prepositional modifiers, and coordinate conjunctions naturally. Make the flow feel organic and alive, not robotic or simplified.\n"
            "4. NATURAL, SPECIFIC VOCABULARY. Do not write with artificial simplicity or sterile language. Use specific, descriptive words rather than sterile, purely functional terms (e.g., use 'incredible', 'freshly baked', 'shape', 'reveal' instead of 'good', 'went', 'had', 'things'). Avoid high-frequency AI words (delve, leverage, robust, crucial, pivotal, tapestry, testament, underscore, foster, enhance, vibrant, landscape, testament, actually, additionally, align with, emphasizing, enduring, garner, highlight, interplay, intricacies, key, valuable).\n"
            "5. NO PRESENT PARTICIPLE OPENERS OR TACK-ONS. Never start sentences with '-ing' phrases (e.g. do not write 'Talking to...', 'Chatting with...'). Also, do not tack '-ing' clauses onto the end of sentences to add fake depth (e.g., do not write '...reflecting their traditions' or '...fostering a sense of community'). Keep sentences direct.\n"
            "6. NO EM DASHES OR EN DASHES (—/–). Use commas, periods, or parentheses instead.\n"
            "7. NO COPULA AVOIDANCE. Use simple 'is', 'are', 'was', 'has', 'had'. Never use 'serves as', 'stands as', 'represents', 'boasts', or 'features' when you mean 'is' or 'has'.\n"
            "8. NO NEGATIVE PARALLELISMS. Avoid structures like 'not only... but also', 'not just... but...', or 'more than just...'. Use direct positive statements.\n"
            "9. REPEAT NOUNS NATURALLY. Do not cycle synonyms.\n"
            "10. NO RULE OF THREE. Avoid grouping verbs, adjectives, or concepts in patterns of three (e.g., do not write 'ideate, iterate, and deliver' or 'customs, lifestyles, and ways of thinking'). Use one or two items instead.\n"
            "11. NO FALSE RANGES or SIGNIFICANCE INFLATION. Avoid arbitrary 'from X to Y' scales. Do not add grandiose claims about how details represent a 'broader movement', 'evolving landscape', or 'pivotal moment'.\n"
            "12. NO GENERIC POSITIVE SUMMARIES OR MORALIZING CLICHÉS. Never end paragraphs or sentences with generic positive summaries or life lessons (e.g., do not write 'You learn and grow', 'It is worth it', 'It helps you adapt'). Keep the tone objective and observational.\n"
        ...
        system_content = (
            ...
            "2. VARY SENTENCE LENGTH AND RHYTHM (BURSTINESS). Do not make all sentences short or uniform. Mix short, punchy sentences (5-10 words) with medium sentences (11-17 words) and a few longer, flowing sentences (18-25 words). The average sentence length should be around 13-16 words. This is critical to avoid monotonous rhythm.\n"
            "3. USE VARIED SYNTAX. Avoid repetitive subject-verb-object structures. Use relative clauses, conditional statements, prepositional modifiers, and coordinate conjunctions naturally. Make the flow feel organic and alive, not robotic or simplified.\n"
            "4. NATURAL, SPECIFIC VOCABULARY & IDIOMS. Do not write with artificial simplicity or sterile language. Use natural human idioms (e.g. 'roll with the punches', 'eye-opening', 'everyday stuff', 'seep into') and descriptive words instead of purely functional terms (e.g. use 'incredible', 'freshly baked', 'shape', 'reveal' instead of 'good', 'went', 'had', 'things'). Avoid both high-frequency AI words (delve, leverage, robust, crucial, pivotal, tapestry, testament, underscore, foster, enhance, vibrant, landscape, testament, actually, additionally, align with, emphasizing, enduring, garner, highlight, interplay, intricacies, key, valuable) and try-hard internet slang (man, oh my god, bro, OMG).\n"
            "5. NO PRESENT PARTICIPLE OPENERS OR TACK-ONS. Never start sentences with '-ing' phrases (e.g. do not write 'Talking to...', 'Chatting with...'). Also, do not tack '-ing' clauses onto the end of sentences to add fake depth (e.g., do not write '...reflecting their traditions' or '...fostering a sense of community'). Keep sentences direct.\n"
            "6. NO EM DASHES OR EN DASHES (—/–). Use commas, periods, or parentheses instead.\n"
            "7. NO COPULA AVOIDANCE. Use simple 'is', 'are', 'was', 'has', 'had'. Never use 'serves as', 'stands as', 'represents', 'boasts', or 'features' when you mean 'is' or 'has'.\n"
            "8. NO NEGATIVE PARALLELISMS. Avoid structures like 'not only... but also', 'not just... but...', or 'more than just...'. Use direct positive statements.\n"
            ...
            "11. NO FALSE RANGES or SIGNIFICANCE INFLATION. Avoid arbitrary 'from X to Y' scales. Do not add grandiose claims about how details represent a 'broader movement', 'evolving landscape', or 'pivotal moment'.\n"
            "12. NO GENERIC POSITIVE SUMMARIES OR MORALIZING CLICHÉS. Never end paragraphs or sentences with generic positive summaries or life lessons (e.g., do not write 'You learn and grow', 'It is worth it', 'It helps you adapt'). Keep the tone objective and observational.\n"
            "13. NO TRY-HARD CASUAL SLANG. Do not use conversational fillers like 'man', 'oh my god', 'you know', 'like', 'stuff', 'hey'. Write clean, plain, standard English.\n"
            "14. Contractions: Use contractions (it's, didn't, wasn't) naturally.\n\n"
            "Output ONLY the rewritten text. No explanations, no introductory text."
        )
        prompt = (
            "Completely rewrite the following paragraph in a natural, expressive, and human style. Apply all rules strictly:\n\n" + para
        )
